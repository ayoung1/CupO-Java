...
public class MainMenuScreen implements Screen{
	...
	private String[] menu = {"Start Game", "Load Game", "Maze Difficulty", "Admin Login", "Exit"};
	private Screen[] screens = {new GameScreen(this), new LoadScreen(this), new SettingsScreen(this), 
